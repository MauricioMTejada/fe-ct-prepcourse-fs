...
function agregarMetodoPrototype(Usuario) {
   ...
   // El método debe llamarse "saludar" y debe devolver 
...
function agregarStringInvertida() {
   // Agrega un método al prototipo de "String" que devuelva la misma cadena de caracteres, 
   // pero invertida.
   // El método debe llamarse "reverse".
   // [PISTA]: necesitarás utilizar el objeto "this".
   // 'hola' -> 'hola'.reverse() -> 'aloh'
